...
function create_else_block(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(button) !== "svelte-rks7u6") button.textContent = textContent_3;
    ...
    h() {
      ...
      attr(button, "class", "px-4 py-2 mt-4 font-bold bg-green-500 rounded text-green-950 hover:bg-green-600 active:bg-green-700 focus:outline-none focus:shadow-outline");
...
function create_fragment(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(div3, "class", "px-2 bg-green-100 md:px-20");
    },
    m(target, anchor) {
